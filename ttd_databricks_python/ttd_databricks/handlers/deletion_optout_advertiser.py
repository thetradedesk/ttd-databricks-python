"""API handler for the /data/deletion-optout/advertiser endpoint."""
...
def call_api(client: DataClient, context: DeletionOptOutAdvertiserContext, items: list[PartnerDsrDataItem], api_token: str) -> list[Any]:
